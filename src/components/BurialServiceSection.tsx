...
const BurialServiceSection = () => {
    return (
        ...
        >
          <p className="text-center text-charcoal-light font-sans text-sm uppercase tracking-widest mb-6">
            Get Directions To
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 px-6 py-4 bg-charcoal text-cream font-sans font-semibold text-sm rounded-lg hover:bg-charcoal-light transition-colors duration-300 shadow-lg hover:shadow-xl"
            >
              <MapPin className="w-5 h-5 text-gold" />
              Church Service
            </a>
            <a
              href="https://maps.app.goo.gl/yii9U3336DjVHCmh6?g_st=ic"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 px-6 py-4 bg-charcoal text-cream font-sans font-semibold text-sm rounded-lg hover:bg-charcoal-light transition-colors duration-300 shadow-lg hover:shadow-xl"
            >
            ...
            {/* <a
              href="https://maps.app.goo.gl/ZaqGaQDXS4nmtZWR6?g_st=ic"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 px-6 py-4 bg-charcoal text-cream font-sans font-semibold text-sm rounded-lg hover:bg-charcoal-light transition-colors duration-300 shadow-lg hover:shadow-xl"
            >
